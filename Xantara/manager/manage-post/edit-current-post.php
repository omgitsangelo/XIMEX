...
<head>
	...
	<!-- Form Style CSS -->
	<link rel="stylesheet" type="text/css" href="../css/manager-form.css?version=1.0" />
...
<body>
  <div class="body-holder">
    ...
    <form id="post-form" action="../php/update-latest-updates.php" method="post">
      <input type="number" value="<?php echo $updates_id ?>" name="ref_no" style="display: none;">
			...
			<div class="row post-form">
				<div class="col-12 col-m-12">
					<input class="save-publish" type="submit" name="submit-edit-post" value="Edit Post" />
				</div>
			</div>
		</form>
  </div>
