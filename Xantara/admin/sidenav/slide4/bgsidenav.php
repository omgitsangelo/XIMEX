...
<div id="BGSidenav" class="sidenav bgsidenav4">
  <form action="../../php/UploadData/Slide4/uploadslide4BG.php" method="post" enctype="multipart/form-data">
    <ul class="ul-list">
      ...
      <li>
        <label class="save-publish">
            <input class="save-button" type="submit" name="submitSlide4BG">
             Save and Publish
        </label>
      </li>
      <br />
