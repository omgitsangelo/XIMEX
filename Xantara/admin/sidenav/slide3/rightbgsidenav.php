...
<div id="BGSidenav" class="sidenav bgsidenav3right">
  <form action="../../php/UploadData/Slide3/uploadslide3rightBG.php" method="post" enctype="multipart/form-data">
    <ul class="ul-list">
      ...
      <li>
        <label class="save-publish">
            <input class="save-button" type="submit" name="submitSlide3rightBG">
             Save and Publish
        </label>
      </li>
      <br />
